        ...
        <div className="row">
          <div className="col col--12">
            <h1 className="hero__title">
              <span className="highlight">Automate</span> <span style={{whiteSpace: "nowrap"}}>end-to-end</span> testing and robotic processing with <span className="highlight">Gwen</span>
            </h1>
          </div>
        </div>
