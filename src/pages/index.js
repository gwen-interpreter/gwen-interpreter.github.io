        ...
        <div className="container">
          <div className="row">
            <div className="col col--12">
              ...
              An embedded web engine executes each step in every scenario according to meta to perform operations in browsers for you. Your features execute unchanged and unconcerned with automation details.
