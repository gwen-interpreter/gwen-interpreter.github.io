...
<details style={{ backgroundColor: '#FFFFFF00' }}>
  ...
  <p>Extracts a substring from the current browser URL using the given regex and binds it to the given name.</p>
  </summary>
  <p>Where</p>
  <ul>
...
<details style={{ backgroundColor: '#FFFFFF00' }}>
  ...
  <p>Binds a selector for a web element contained inside another to the current scope.</p>
  </summary>
  <p>Where</p>
  <ul>
    <li><code>&lt;element&gt;</code> is the web element name</li>
