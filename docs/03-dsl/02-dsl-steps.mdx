...
All Gherkin steps that match the DSL expressions here are readily executable. The DSL matched is the operation that Gwen will perform when a step is interpreted for execution.
...
<details style={{ backgroundColor: '#FFFFFF00' }}>
  ...
  <p>Extracts a substring from the current browser URL using the given regex expression and binds the value to the given name.</p>
  </summary>
  <ul>
...
<details style={{ backgroundColor: '#FFFFFF00' }}>
  ...
  <ul>
    <li><code>[ not]</code> = include the word <code>not</code> to negate the match</li>
  ...
  <ul>
    ...
    <li><code>&lt;selector&gt;</code> = the selector type, one of:
      <ul>
        ...
        <li><b>tag</b> : shorthand for <b>tag name</b>, since v<Link to="https://github.com/gwen-interpreter/gwen-web/releases/tag/v2.46.0">2.46.0</Link></li>
        <li><b>css selector</b> : for selecting by css expression</li>
        <li><b>css</b> : shorthand for <b>css selector</b>, since v<Link to="https://github.com/gwen-interpreter/gwen-web/releases/tag/v2.46.0">2.46.0</Link></li>
        <li><b>class name</b> : for selecting by class attribute</li>
        <li><b>class</b> : shorthand for <b>class name</b>, since v<Link to="https://github.com/gwen-interpreter/gwen-web/releases/tag/v2.46.0">2.46.0</Link></li>
        ...
        <li><b>js</b> : shorthand for <b>javascript</b>, since v<Link to="https://github.com/gwen-interpreter/gwen-web/releases/tag/v2.46.0">2.46.0</Link></li>
      </ul>
    </li>
