...
<a class="dsl" id="element-can-be-located-by-selector-expressions" />
<details>
  <summary class="dsl">
  ...
  <p>
    Binds multiple selectors for a web element to the current scope (with a default timeout for each).
