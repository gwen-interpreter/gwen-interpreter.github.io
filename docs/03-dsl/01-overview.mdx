...
Use [dry runs](https://github.com/gwen-interpreter/gwen/wiki/Execution-Modes#dry-run-execution-and-validation) to check for syntax and binding errors and identify missing StepDefs before committing to an automation cycle.
