...
<details style={{ backgroundColor: '#FFFFFF00' }}>
  ...
  <details>
    ...
    <pre>
    And I navigate to "{'${the current URL}'}/relative/page.html"
    </pre>
    <ul>
      <li><code>&lt;url&gt;</code> = {'${the current URL}'}/relative/page.html
        <ul><li>Where <b>{'${the current URL}'}</b> will resolve to the captured URL</li></ul>
      </li>
    </ul>
  </details>
...
<details style={{ backgroundColor: '#FFFFFF00' }}>
  ...
  <details>
    ...
    <ul>
      <li><code>&lt;name&gt;</code> = the base URL</li>
    </ul>
    <pre>
    And I navigate to "{'${the base URL}'}/relative/page.html"
    </pre>
    <ul>
      <li><code>&lt;url&gt;</code> = {'${the base URL}'}/relative/page.html
        <ul><li>Where <b>{'${the base URL}'}</b> will resolve to the captured URL</li></ul>
      </li>
    </ul>
    <pre>
    ...
    <ul>
      <li><code>&lt;match&gt;</code> = start with</li>
      <li><code>&lt;name&gt;</code> = the base URL</li>
    </ul>
  </details>
...
<details style={{ backgroundColor: '#FFFFFF00' }}>
  ...
  <details>
    <summary>Example usage</summary>
    <pre>
    When I capture the text in the current URL by regex "id=([^&]*)" as the id param
    </pre>
    <ul>
      <li><code>&lt;regex&gt;</code> = id=([^&]*)
        <ul><li>Extracts the value of the query string parameter named id from the current URL</li></ul>
      </li>
      <li><code>&lt;name&gt;</code> = the id param</li>
    </ul>
    <pre>
    Then the id param should be "gwen"
    </pre>
    <ul>
      <li><code>&lt;name&gt;</code> = the id param</li>
      <li><code>&lt;match&gt;</code> = be</li>
      <li><code>&lt;expression&gt;</code> = gwen</li>
    </ul>
  </details>
