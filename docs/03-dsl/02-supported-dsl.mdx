...
<details style={{ backgroundColor: '#FFFFFF00' }}>
  <summary>
    the <code>&lt;page&gt;</code> url is "<code>&lt;url&gt;</code>"
  </summary>
...
<details style={{ backgroundColor: '#FFFFFF00' }}>
  <summary>
    I capture the current URL as <code>&lt;name&gt;</code>
  </summary>
...
<details style={{ backgroundColor: '#FFFFFF00' }}>
  <summary>
    I capture the text in the current URL by regex "<code>&lt;expression&gt;</code>" as <code>&lt;name&gt;</code>
  </summary>
...
<details style={{ backgroundColor: '#FFFFFF00' }}>
  <summary>
    the current URL should <code>[not] &lt;match&gt;</code> "<code>&lt;expression&gt;</code>"
  </summary>
...
<details style={{ backgroundColor: '#FFFFFF00' }}>
  <summary>
    the current URL should <code>[not] &lt;match&gt;</code> <code>&lt;name&gt;</code>
  </summary>
...
<details style={{ backgroundColor: '#FFFFFF00' }}>
  <summary>
    <code>&lt;element&gt;</code> can be located by <code>&lt;selector&gt;</code> "<code>&lt;expression&gt;</code>"
  </summary>
...
<details style={{ backgroundColor: '#FFFFFF00' }}>
  <summary>
    <code>&lt;element&gt;</code> can be located by <code>&lt;selector&gt;</code> "<code>&lt;expression&gt;</code>" in <code>&lt;container&gt;</code>
  </summary>
  <p>
    Defines a <Link to="https://github.com/gwen-interpreter/gwen-web/wiki/Locator-Chaining">chained</Link> selector for a web element contained in another element and gives it a <Link to="https://github.com/gwen-interpreter/gwen-web/wiki/Runtime-Settings#gwenweblocatorwaitseconds">default timeout</Link>.
  </p>
  <ul>
    <li><code>&lt;element&gt;</code> = the web element name</li>
    <li><code>&lt;selector&gt;</code> = the selector type, one of:
...
<details style={{ backgroundColor: '#FFFFFF00' }}>
  <summary>
    <code>&lt;element&gt;</code> can be located by<br />
    &nbsp; &nbsp; <code>| &lt;selector 1&gt; | &lt;expression 1&gt; |</code><br />
    &nbsp; &nbsp; <code>| &lt;selector 2&gt; | &lt;expression 2&gt; |</code><br />
    &nbsp; &nbsp; <code>| &nbsp; &nbsp; &nbsp;..&nbsp; &nbsp; &nbsp; | &nbsp; &nbsp; &nbsp; .. &nbsp; &nbsp; &nbsp; |</code><br />
    &nbsp; &nbsp; <code>| &lt;selector n&gt; | &lt;expression n&gt; |</code>
  </summary>
  <p>
