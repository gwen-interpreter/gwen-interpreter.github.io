...
> The current CSV record number (starting at 1) is available as an implicit attribute named `data record number` and can be accessed by reference or [interpolation](https://github.com/gwen-interpreter/gwen/wiki/String-Interpolation).
