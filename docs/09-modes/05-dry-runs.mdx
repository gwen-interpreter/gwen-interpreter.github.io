...
Results will be logged to the console and in [HTML reports](/docs/reports/html) that you can open to quickly find any issues.

#### Example 

If you leave out or forget to define a selector for an input field, it would be reported in the HTML report as follows:
