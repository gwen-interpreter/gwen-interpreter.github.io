...
Setting up Gwen to run in a dynamic [Se Grid](https://github.com/SeleniumHQ/docker-selenium?tab=readme-ov-file#dynamic-grid) in Docker is describe here.

:::info
Since [v4.2.0](https://github.com/gwen-interpreter/gwen-web/releases/tag/v4.2.0), Gwen will generate docker files targetting the [Se Grid](https://github.com/SeleniumHQ/docker-selenium?tab=readme-ov-file#dynamic-grid) instead of [Selenoid](https://github.com/aerokube/selenoid).
:::
...
The init --docker commad will create a `gwen/docker-compose.yml` file with the following content to create a dynamic Se Grid in Docker that Gwen will connect to.
