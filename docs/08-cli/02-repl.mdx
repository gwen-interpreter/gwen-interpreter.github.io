...
Tab completion is enabled by default. You can disable it by setting [`gwen.console.repl.tabCompletion`](/docs/settings/reference#gwen-console-repl-tabCompletion) to `false`.
...
Auto suggestions are enabled by default. You can disable them by setting [`gwen.console.repl.autoSuggestions`](/docs/settings/reference#gwen-console-repl-autoSuggestions) to `false`.
