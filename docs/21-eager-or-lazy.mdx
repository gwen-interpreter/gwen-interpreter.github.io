...
- [`<name> is defined by <javascript|js> "<expression>"`](/docs/dsl#name-is-defined-by-javascript-expression)
...
- [`<name> is defined by file "<filepath>"`](/docs/dsl#name-is-defined-by-file)
