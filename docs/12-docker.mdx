...
This sets the default browser to chrome via the [GWEN_BROWSER](/docs/cli#environment-variables) variable. You can change it to another browser if you wish.
...
This script will be called by the `gwen` container in the [docker-compose](#docker-compose-file) file generated above.
...
If you're running Chrome or Edge in a Selenoid docker container on Mac ARM processor and encounter the following error
