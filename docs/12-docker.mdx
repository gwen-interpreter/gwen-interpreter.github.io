...
Create the following Docker and Selenoid files in your project using the [`init --docker`](/docs/cli#gwen-cli-options-init-docker) command as shown below. This command is available since Gwen v3.16.0. You will need to create the files manually if you are using an older version.
