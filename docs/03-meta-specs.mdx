...
Meta specs are [Gherkin](https://cucumber.io/docs/gherkin/reference/) specs that describe how feature specs will execute and are the automation glue in Gwen. They define all the step definitions and bindings required for automation and attach to features at runtime.
