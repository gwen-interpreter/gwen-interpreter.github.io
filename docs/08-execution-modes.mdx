...
Gwen will open the [REPL console](/docs/cli/repl) when it finishes executing features unless [batch](/docs/exeuction-modes#batch) mode is enabled.

## Sequential

> Since [v1.0.0](https://github.com/gwen-interpreter/gwen-web/releases/tag/v1.0.0)

Gwen will execute given feature files one after the other unless [parallel](/docs/exeuction-modes#parallel) execution is enabled.
