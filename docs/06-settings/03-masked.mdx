...
It is a common security practice is to never log user credentials and sensitive data. Automated tests often use passwords to log into applications. In such cases care should be taken to protect and hide passwords from logs, reports, error messages and console outputs.
