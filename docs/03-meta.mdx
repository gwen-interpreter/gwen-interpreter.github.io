...
To load a single meta file from an external directory, use the [`-m|meta`](/docs/launcher#gwen-launch-options-meta) launch option and specify the path to the meta file:
