...
The external strategy enables you to manage common and reusable meta files (in addition to associateve meta) in a directory that is separate or external to your features directory. How you name your meta files or manage your meta directory structure does not matter.
