...
:::info
DryRun annotations are only honoured at dry-runtime and are completely ignored otherwise!
:::
...
This will result in a successful dry run of both the 1st and 2nd step definitions. So now the entire meta and will be exercised.
