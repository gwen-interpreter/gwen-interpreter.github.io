...
- [`gwen.web.chrome.mobile.deviceName`](/docs/settings#gwen-web-chrome-mobile-emulation)
- [`gwen.web.edge.mobile.deviceName`](/docs/settings#gwen-web-edge-mobile-emulation)
