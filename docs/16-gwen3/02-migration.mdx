...
The following new setting has a configured default that changes prior behavior. If you want to revert to the prior behavior, override it in your settings file accordingly.

| New Setting                                                                                                       | Before v3.15.0  | Since v3.15.0 |
| :---------------------------------------------------------------------------------------------------------------- | :-------------: | :-----------: |
| [`gwen.auto.bind.tableData.outline.examples`](/docs/settings/reference#gwen-auto-bind-tableData-outline-examples) | `false`         | `true`        |
