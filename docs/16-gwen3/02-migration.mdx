...
### New setttings impacting prior behavior

The following new settings have configured defaults that change prior behavior. If you want to revert to the prior behavior, you will need to explicitly set these in your settings file accordingly.
