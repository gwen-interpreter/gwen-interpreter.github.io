...
The [`gwen.behavior.rules`](/docs/settings/reference#gwen-behavior-rules) setting now defaults to *strict* instead of *lenient* to enforce correct behavioral semantics and proper Given-When-Then order.
