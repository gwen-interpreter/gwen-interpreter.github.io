...
- To generate HTML [reports](/docs/reports/html), add `-r output/reports` to the command
...
- The above will all generate HTML [reports](/docs/reports/html) to `target/reports`
