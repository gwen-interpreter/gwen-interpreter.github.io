...
> Since [v3.34.0](https://github.com/gwen-interpreter/gwen-web/releases/tag/v3.34.0)
  - Gwen enables you to switch between [SeleniumManager](https://www.selenium.dev/blog/2022/introducing-selenium-manager/) (default) and [WebDriverManager](https://github.com/bonigarcia/webdrivermanager) with the [`gwen.web.driver.manager`](/docs/settings#gwen-web-driver-manager) setting
