...
Use [dry runs](/docs/exeuction-modes#dry-runs) to check for syntax and binding errors and identify any missing StepDefs before committing to an automation cycle.
