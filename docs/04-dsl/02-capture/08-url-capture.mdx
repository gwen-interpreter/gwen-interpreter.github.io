...
<details open id="i-capture-the-current-url">
  <summary class="dsl">
...
<details open id="i-capture-the-current-url-as-name">
  <summary class="dsl">
...
<details open id="i-capture-the-text-in-the-current-url-by-regex-as-name">
  <summary class="dsl">
