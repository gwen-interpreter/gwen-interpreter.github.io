...
<details open id="i-capture-text-ref-as-name">
  <summary class="dsl">
...
<details open id="i-capture-element">
  <summary class="dsl">
...
<details open id="i-capture-element-as-name">
  <summary class="dsl">
...
<details open id="i-capture-name-of-element-by-javascript-expression">
  <summary class="dsl">
