...
<details open id="step-for-each-element-located-by-selector-expression">
  <summary class="dsl">
...
<details open id="step-for-each-element-located-by-selector-expression-in-container">
  <summary class="dsl">
...
<details open id="step-for-each-element-in-elements">
  <summary class="dsl">
...
<details open id="step-for-each-data-record">
  <summary class="dsl">
...
<details open id="for-each-entry-in-text-ref-delimited-by">
  <summary class="dsl">
...
<details open id="for-each-entry-in-json-array">
  <summary class="dsl">
