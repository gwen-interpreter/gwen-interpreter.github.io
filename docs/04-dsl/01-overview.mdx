...
Every Gherkin steps that matches a [prescribed DSL](/docs/dsl/reference) is considerd a DSL step and is readily executable by Gwen.
...
Every step interpreted by Gwen will directly or inderectly through [StepDefs](/docs/meta-specs#stepdefs) result in either:
