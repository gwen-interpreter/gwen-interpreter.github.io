...
<details open id="name-is-defined-by-javascript-expression">
  <summary class="dsl">
  ...
  ```gherkin {1}
    Given UTC date is defined by js "new Date().toISOString().substring(0, 10)"
     Then UTC date should match regex "^\d{4}-([0]\d|1[0-2])-([0-2]\d|3[01])$"
  ```
...
<details open id="name-is-defined-by-js-function-applied-to-arg">
  <summary class="dsl">
  ...
  ```gherkin {9}
    Given iso UTC date is defined by js "new Date().toISOString().substring(0, 10)"
      And toDMY is defined by js
          ...
          """
      And dmy UTC date is defined by toDMY applied to "${iso UTC date}"
     Then dmy UTC date should match regex "^([0-2]\d|3[01])/([0]\d|1[0-2])/\d{4}$"
  ```
...
<details open id="name-is-defined-by-js-function-applied-to-args-delimited-by">
  <summary class="dsl">
...
<details open id="name-is-defined-by-js-function-applied-to-element">
  <summary class="dsl">
