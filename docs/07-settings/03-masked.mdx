...
Alternatively, you can pass a masked setting directly to the [Gwen CLI](/docs/cli) if you don't wish to store it in your settings file:

```shell
-Duser.password:masked='${env.USER_PASSWORD}'
```
