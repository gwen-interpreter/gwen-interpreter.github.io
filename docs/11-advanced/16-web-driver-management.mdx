...
If you wish to have more control over driver versions or other aspects of this process, you can configure explicit `wdm.*` configuration options in your [Gwen settings](/docs/settings) file. See the [WebDriverManager documentation](https://bonigarcia.dev/webdrivermanager/#driver_management_config) for information about these options.
