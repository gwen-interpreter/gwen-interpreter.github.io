...
For example, say you wanted to click an action button in a menu item that only becomes visible when you physically move into the menu item by hovering over it with the mouse. You can do this as follows:
