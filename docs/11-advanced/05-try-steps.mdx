...
Steps annotated with `@Try` will always be treated as Passed, reagardless of whether they execute succesfully or fail. In the event of failure, the step will be greyed out in the HTML reports and attachments on the step will still contain the error details should you wish to analyse them.
