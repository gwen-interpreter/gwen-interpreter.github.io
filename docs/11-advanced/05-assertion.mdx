...
> Since [v2.43.0](https://github.com/gwen-interpreter/gwen-web/releases/tag/v2.43.0), the `@Hard` annotation can be used on any assertion step to make it fail hard.
...
> Since [v2.43.0](https://github.com/gwen-interpreter/gwen-web/releases/tag/v2.43.0), the `@Soft` annotation can be used on any assertion step to make it fail soft.
...
> Since [v2.43.0](https://github.com/gwen-interpreter/gwen-web/releases/tag/v2.43.0), the `@Sustained` annotation can be used on any assertion step to make it sustained.
...
The `@Hard`, `@Soft` and `@Sustained` annotations introduced in [v2.43.0](https://github.com/gwen-interpreter/gwen-web/releases/tag/v2.43.0) can be used on individiual steps to override the default assertion mode setting.
