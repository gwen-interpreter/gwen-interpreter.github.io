...
Start with the intention of writing features specs to communicate requirements without giving any thought to automation. Then when it makes sense to automate, compose your meta and progressively maintain a useful subset that can execute often.
