...
## Gwen automation
 ...
 Gwen is a [Gherkin](https://cucumber.io/docs/gherkin/reference/) interpreter for driving automation with feature specifications. Automation is achieved through [meta specs](https://github.com/gwen-interpreter/gwen/wiki/Meta-Features) which you compose with the [Gwen DSL](https://github.com/gwen-interpreter/gwen-web/wiki/Supported-DSL) and bind to steps in your features. An embedded web engine translates and executes each step accordingly to perform operations in browsers consistently and reliably.
