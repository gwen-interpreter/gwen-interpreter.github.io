...
## Gwen automation
 ...
 Gwen is a [Gherkin](https://cucumber.io/docs/gherkin/reference/) interpreter for driving automation with feature specifications. Automation is achieved through bindings in [meta specs](https://github.com/gwen-interpreter/gwen/wiki/Meta-Features) which you compose with the [Gwen DSL](https://github.com/gwen-interpreter/gwen-web/wiki/Supported-DSL). An embedded web engine translates and executes each step accordingly to perform operations in browsers for you. Your feature specs remain unchanged but suddenly executable.
