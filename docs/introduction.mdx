...
## Gwen automation
 ...
 Gwen is a [Gherkin](https://cucumber.io/docs/gherkin/reference/) interpreter for driving automation with feature specifications. Execution is achieved through bindings in [meta specs](https://github.com/gwen-interpreter/gwen/wiki/Meta-Features) which you compose with the [Gwen DSL](https://github.com/gwen-interpreter/gwen-web/wiki/Supported-DSL). An embedded web engine translates and executes each feature step according to the bindings to automate operations in browsers for you. Your feature specs remain unchanged but suddenly executable.

#### Recommended approach

Start with the intention of writing specifications to describe feature behaviors without giving any thought to automation or execution. Then when it makes sense to automate, compose your meta incrementally and maintain a useful suite of specifications that you can execute often.

:::tip
Read on to learn more about Gwen before [getting started](/docs/get-started).
:::
