...
:::tip
Confine all your DSL usage to StepDefs in Meta. Although it's possible to use DSL steps directly in features, we do not recommend making them DSL-aware. That's what meta is for!
