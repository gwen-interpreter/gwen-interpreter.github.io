...
StepDefs can override DSL steps to alter or add additional steps around them. If a StepDef calls itself however, an error will be reported to prevent infinite recursion.
