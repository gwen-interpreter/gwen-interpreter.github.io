...
#### Choose your current Gwen setup
...
[Gwen workspaces](https://gweninterpreter.wordpress.com/2017/12/18/gwen-workspaces/) were introduced in Gwen 2 and have been deprecated in favor of JS projects in  [Gwen 3](/docs/gwen3).
...
<Tabs
  ...
  defaultValue="gwen3"
  values={[
    {label: 'Migrate to a Gwen 3 JS project', value: 'gwen3'},
    {label: 'Stay on a Gwen 2 workspace', value: 'gwen2'},
  ]}>

<TabItem value="gwen3">

Follow the instructions on our [getting started](/docs/get-started) page to create a new JS project with a fresh Gwen 3 setup, and then copy the following files from your workspace to your JS project:
...
| Removed alias          | Always use this name                                                  |
| :--------------------- | :-------------------------------------------------------------------- |
...
| Setting                                                                                                           | Prior default | New default   |
| :---------------------------------------------------------------------------------------------------------------- | :-----------: | :-----------: |
...
### New setttings impacting prior defaults

The following new settings have defaults that change the default behavior in prior versions. If you want to preserve prior behavior, explicity set them in your current properties file.

| Setting                                                                                                           | Since          | To preserve prior behavior | New default |
| :---------------------------------------------------------------------------------------------------------------- | :------------: | :------------------------: | :---------: |
...
Two new settings formats have been added:
...
Gwen uses log4j2 as of v3.1.0 (and v2.54.0 for Gwen 2). If you are passing custom `log4j.properties` files to Gwen, you will need to update them to [v2 `log4j2.properties` files](https://logging.apache.org/log4j/2.x/manual/configuration.html#Configuration_with_Properties). 
