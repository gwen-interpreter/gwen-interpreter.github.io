...
The following new settings have new defaults that change prior behavior. If you want to preserve the prior behavior, explicity set them in your current settings file.

| Setting                                                                                                           | Since          | Changed from | To     |
| :---------------------------------------------------------------------------------------------------------------- | :------------: | :----------: | :----: |
