...
:::note
Videoes can also be captured if you run Gwen on [BrowserStack](/docs/browserstack) or [LambdaTest](/docs/lambdatest) however they are maintained on their dashboards and are not integrated into Gwen HTML reports.
:::
