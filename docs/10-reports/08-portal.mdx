...
<details id="gwen-rp-send-meta">
  ...
  <ul>
    ...
    <li><code>false</code> to not send meta results (default)
...
<details id="gwen-rp-send-stepDefs">
  ...
  <ul>
    ...
    <li><code>none</code> to not send StepDefs (default)
...
<details id="gwen-rp-send-failed-stepDefs">
  ...
  <p>Supported values</p>
  <ul>
    <li><code>inlined</code> to inline failed StepDefs as log messages (default)
...
<details id="gwen-rp-send-failed-errorTrace">
  ...
  <ul>
    ...
    <li><code>none</code> to not send error traces (default)
...
<details id="gwen-rp-send-failed-envTrace">
  ...
  <ul>
    ...
    <li><code>none</code> to not send environment traces (default)
...
<details id="gwen-rp-send-failed-hierarchy">
  ...
  <ul>
    ...
    <li><code>inlined</code> to inline call trace hierarchies as log messages (default)
...
<details id="gwen-rp-send-breadcrumbs">
  ...
  <ul>
    ...
    <li><code>false</code> to not send breadcrumbs (default)
...
<details id="gwen-rp-send-failed-errorBlocks">
  ...
  <ul>
    ...
    <li><code>none</code> to not send error blocks (default)
...
<details id="gwen-rp-send-tags">
  ...
  <p>Supported values</p>
  <ul>
    <li><code>true</code> to send tags (default)
...
<details id="gwen-rp-send-markdownBlocks">
  ...
  <p>Supported values</p>
  <ul>
    <li><code>true</code> to log inlined steps in markdown blocks (default)
...
<details id="gwen-rp-heartbeat-enabled">
  ...
  <p>Supported values</p>
  <ul>
    <li><code>true</code> to enable heartbeats (default)
      <ul>
...
<details id="gwen-rp-heartbeat-timeoutSecs">
  ...
  <p>Supported values</p>
  <ul>
    <li>A positive integer denoting the number of seconds to wait for a heartbeat response before timing out (default = <code>3</code>).
      <ul>
