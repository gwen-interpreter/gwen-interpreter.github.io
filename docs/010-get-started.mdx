...
Gwen has an embedded web driver manager which automatically downloads and installs native web drivers for you on most platforms. If however you need to manage this manually, see [Web Driver Management](/docs/web-driver-management) and [Web Settings](/docs/settings/reference#web-settings) for options.
