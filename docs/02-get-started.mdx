...
Gwen is configured to target the Chrome browser and your *test* environment by default. To change these, amend the  [<code>gwen.target.browser</code>](/docs/settings/reference#gwen-target-browser) and [<code>gwen.target.env</code>](/docs/settings/reference#gwen-target-env) settings to your preferred values.
