...
<TabItem value="project">
 ...
 Use this option to add Gwen to an existing project or to start a new one.
 
 > This is the recommended option since everything will be self contained and [Git](https://git-scm.com/) ready.

### System requirements
  - Linux, Mac or Windows OS
  - Before you can start, you will need to you have the following installed:
    - [Chrome](https://www.google.com/intl/en_au/chrome/), [Firefox](https://www.mozilla.org/en-US/firefox/new/), [Edge](https://www.microsoft.com/en-us/edge), or [Safari](https://www.apple.com/au/safari/) browser
...
Add Gwen to an existing or new project using one of the following tools. 

> [Yarn](https://yarnpkg.com/) is recommended for ease of use.
...
If you don't have a project, [install node](https://nodejs.org/en/download/package-manager) and create a new one by running the following command in a new directory (otherwise open a command prompt in the root directory of your existing project):
...
### System requirements
  - Linux, Mac or Windows OS
  - Before you can start, you will need to you have the following installed:
    - [Chrome](https://www.google.com/intl/en_au/chrome/), [Firefox](https://www.mozilla.org/en-US/firefox/new/), [Edge](https://www.google.com/intl/en_au/chrome/), or [Safari](https://www.apple.com/au/safari/) browser
    - [Java 8+](https://java.com) JRE (no need for JDK unless you really want it)
