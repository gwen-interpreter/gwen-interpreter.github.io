...
For example, Gwen is configured to use the Chrome browser by default. To change this, amend the  [<code>gwen.target.browser</code>](/docs/settings/reference#gwen-target-browser) setting to a different browser.
...
Also, the following defaults are pre-configured to help promote [good Gherkin](https://gweninterpreter.wordpress.com/2020/03/09/strictly-good-gherkin-with-gwen/) practice:

- [`gwen.feature.mode`](/docs/settings/reference#gwen-feature-mode) is set to `declarative` to confine your [DSL](/docs/dsl) usage to [meta](/docs/meta) and keep your features clean
- [`gwen.behavior.rules`](/docs/settings/reference#gwen-behavior-rules) is set to `strict` to enforce proper [behavioral rules](/docs#behavioral-rules-and-semantics) and *Given-When-Then* order

You might choose to relax these by setting them to `imperative` and `lenient` (respectively) if you find them too rigid.
...
Also, the following settings are pre-configured with [strictly good Gherkin](https://gweninterpreter.wordpress.com/2020/03/09/strictly-good-gherkin-with-gwen/) in mind:

- [`gwen.feature.mode`](/docs/settings/reference#gwen-feature-mode) is set to *declarative* to help keep your features high level and declarative
- [`gwen.behavior.rules`](/docs/settings/reference#gwen-behavior-rules) is set to *strict* to enforce proper behavioral semantics and Given-When-Then order

You might choose to relax these by setting them to *imperative* and *lenient* instead if you find them too rigid.
