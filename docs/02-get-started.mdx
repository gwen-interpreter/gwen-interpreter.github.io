...
Gwen is configured to target the Chrome browser and your *local* environment by default. To change these, amend the  [<code>gwen.target.browser</code>](/docs/settings/reference#gwen-target-browser) and [<code>gwen.target.env</code>](/docs/settings/reference#gwen-target-env) settings to your preferred values.
...
- [`gwen.behavior.rules`](/docs/settings/reference#gwen-behavior-rules) is set to `strict` to enforce proper [behavioural rules](/docs#behavioural-rules-and-semantics) and *Given-When-Then* order
...
- [`gwen.behavior.rules`](/docs/settings/reference#gwen-behavior-rules) is set to *strict* to enforce proper behavioural semantics and Given-When-Then order
