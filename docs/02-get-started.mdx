...
### Open a terminal window in your project

Open a terminal window in a new or exising project directory.
...
<TabItem value="new">
Create a new directory somewhere on your machine and open a terminal window in that.
</TabItem>

<TabItem value="existing">
Open a terminal window in the root of your existing project.
</TabItem>
...
Add Gwen to your project using one of the following tools. 
...
If you have problems, add the following to the `scripts` section of your `package.json` file, and try again.
