...
> Gwen = [<b>G</b>]iven [<b>W</b>]hen Th[<b>en</b>]

Gwen is a [Gherkin](https://cucumber.io/docs/gherkin/reference/) interpreter for driving automated testing and robotic processing with feature specifications that describe behavior.
...
<CodeBlock language="gherkin" metastring='{2-3}'>
{`  @Context
  @StepDef
  Scenario: a new todo list
    Given my todo list can be located by css ".todo-list"
...
<Admonition type="note" title="Conf">
<p>
...
<Admonition type="note" title="Json">
<p>
...
<CodeBlock language="gherkin" metastring='{2-5}'>
{`  @Action
  @StepDef
  @DataTable
  @ForEach
...
<CodeBlock language="gherkin" metastring='{2-3,5}'>
{`  @Assertion
  @StepDef
  Scenario: the list will contain <expected-count> items
    Given the displayed count can be located by css ".todo-count strong"
...
<CodeBlock language="gherkin" metastring='{1}'>
{`  @Assertion
  @StepDef
  Scenario: the list will contain <expected-count> items
    Given the displayed count can be located by css ".todo-count strong"
...
<Admonition type="info" title="Strict by default">
<p>
...
<Admonition type="info" title="Associative by default">
<p>
