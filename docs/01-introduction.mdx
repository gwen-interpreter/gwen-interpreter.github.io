...
Compose [meta specs](/docs/meta) to formulate how scenarios will execute using the [Gwen DSL](/docs/dsl).
...
Launch Gwen to load your meta and execute your specifications to automate.
