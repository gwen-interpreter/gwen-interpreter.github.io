...
Meta specifications describe what Gwen will execute and are maintained in Gherkin meta files that bind to your features when Gwen is launched. All the step definitions and bindings required for automation are defined in meta so your features remain unconcerned with this detail.
