...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/img/gwen-logo-color.svg'),
    dark: useBaseUrl('/img/gwen-logo-white.svg'),
  }}
  width="250px"
  height="125px"
/>
...
Gwen is a <Link href="https://cucumber.io/docs/gherkin/reference/">Gherkin</Link> interpreter that helps teams automate end-to-end testing and robotic processing with behaviour described in feature specifications.
...
<p><img src="/img/icon-feature.svg" width="200px" height="200px"/></p>
...
<p><img src="/img/icon-meta.svg" width="200px" height="200px"/></p>
