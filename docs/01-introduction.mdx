...
Gwen is a tool for automating acceptance testing and robotic processing with behavior defined in [Gherkin](https://cucumber.io/docs/gherkin/reference/) feature specifications.
