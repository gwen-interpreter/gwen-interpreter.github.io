...
Declare [feature specs](https://cucumber.io/docs/gherkin/reference/) to describe how scenarios should behave in the language of your domain.
...
Feature specs are used to communicate requirements that are clear, concise and declarative. For example, the following describes how adding items to a todo list should behave.
...
Declare [meta specs](/docs/meta) to describe how scenarios will execute using the [Gwen DSL](/docs/dsl).
...
Launch Gwen to load your meta and execute your features to automate scenarios.
