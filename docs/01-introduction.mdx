...
<p>
  <ThemedImage
    alt="Gwen logo"
    sources={{
      light: useBaseUrl('/img/gwen-logo-cw.png'),
...
:::tip Keep features declarative
  <p>Write feature specs from a third person user or system perspective without giving any thought to automation.</p>
:::
...
:::info Meta is necessarily imperative
  <p>Write meta specs from your own first person perspective with automation completely in mind.</p>
:::
