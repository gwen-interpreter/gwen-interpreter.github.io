...
Gwen is a tool for automating acceptance testing and robotic processing with [Gherkin](https://cucumber.io/docs/gherkin/reference/) feature specifications that describe behavior.
...
<p>
Your Gwen usage need not be confined to just testing. You can automate repetitive manual processesing too!
</p>
:::
