...
Write feature specs without giving any thought to automation. Then when it makes sense to automate, compose your meta incrementally and maintain a useful suite of executable specifications that you can run often.
