...
- Many [report formats](/docs/reports/html)
- Configurable [settings](/docs/settings) and [CLI](/docs/cli)
- Multiple web element [locator mechanisms](https://gweninterpreter.wordpress.com/2019/08/13/locating-web-elements-with-gwen/) (including JS)
- JS [arrow functions](/docs/js-functions)
