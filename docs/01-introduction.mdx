...
Feature specs are used to communicate scenarios in the language of your domain. They should clear, concise and declarative. For example, the following describes how adding items to a todo list should behave.
