...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/img/gwen-logo-landscape-color.svg'),
    dark: useBaseUrl('/img/gwen-logo-landscape-white.svg'),
  }}
  width="250px"
  height="125px"
/>
...
<p><img src="/img/gwen-declare-features.svg" width="200px" height="200px"/></p>
...
<p><img src="/img/gwen-compose-meta.svg" width="200px" height="200px"/></p>
...
&nbsp; &nbsp; &nbsp; &nbsp; <ThemedImage
  alt="Docusaurus themed image"
  sources={{
    light: useBaseUrl('/img/gwen-attractor-color.svg'),
    dark: useBaseUrl('/img/gwen-attractor-white.svg'),
  }}
  width="135px" 
  height="135px"
/>
