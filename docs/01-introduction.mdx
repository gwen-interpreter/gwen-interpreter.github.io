...
Write [feature specs](https://cucumber.io/docs/gherkin/reference/) to describe how scenarios should behave.
...
Write [meta specs](/docs/meta) to describe how steps will execute to automate scenarios.
