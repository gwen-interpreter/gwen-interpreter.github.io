...
Gwen is a [Gherkin](https://cucumber.io/docs/gherkin/reference/) interpreter for driving automated testing and robotic processing with behavioral feature specifications.
...
|       `@Assertion`        |                 Then                  | Thens imply expectations |
