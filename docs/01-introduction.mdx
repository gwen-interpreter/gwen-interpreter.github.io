...
Gwen is a <Link href="https://cucumber.io/docs/gherkin/reference/">Gherkin</Link> interpreter that helps teams automate acceptance testing and robotic processing with behaviour described in feature specifications.
...
<img src="/img/feature-specs-intro.svg" width="200px" height="200px"/>

Feature specs are used to communicate scenarios in the language of your domain. They should be clear, concise and declarative. For example, the following describes how adding items to a todo list should behave.
...
Compose [meta specs](/docs/meta) to formulate how scenarios will execute.

<img src="/img/meta-specs-intro.svg" width="200px" height="200px"/>
...
<img src="/img/gwen-interpreter-intro.svg" width="200px" height="200px"/>
