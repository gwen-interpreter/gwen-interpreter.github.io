...
In addition to the standard CLI options, you can also pass in any number of system properties and JVM options.

Supported arguments and options include:
...
- `-Dprop.name=value`
  ...
  - Accessible in feature and meta specs as `${prop.name}`
- `-J<OPTION>`
