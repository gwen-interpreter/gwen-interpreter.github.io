...
In addition to the standard CLI options, you can also pass Java arguments. This is useful when you want to pass in system properties directly or tweak JVM options on the Java process that runs Gwen.
