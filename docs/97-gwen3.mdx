...
- [Setting capabilities via protocol extensions](/docs/settings/reference#gwen-web-capabilities)
...
| [`gwen.web.assertions.maxStrikes`](/docs/settings/reference#gwen-web-assertions-maxStrikes)                       | v3.41.0 | `infinity`    | `3`         |
| [`gwen.web.assertions.maxStrikes`](/docs/settings/reference#gwen-web-assertions-maxStrikes)                       | v3.42.9 | `infinity`    | `5`         |
| [`gwen.web.assertions.maxStrikes`](/docs/settings/reference#gwen-web-assertions-maxStrikes)                       | v3.52.0 | `infinity`    | `auto`      |
