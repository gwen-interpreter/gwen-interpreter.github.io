...
"scripts": {
  "gwen": "gwen",
  "gwen:hyperexecute": "./hyperexecute --config gwen/LT-HyperExecute.yml --download-artifacts --download-artifacts-path gwen/output/lt-artefacts --force-clean-artifacts"
}
```
...
Then call the `gwen:hyperexecute` script in your project to launch your Gwen features on HyperExecute.
