...
And to download your `package.json` dependencies from a local or private hosted repostitory, you will need to additionally configure npm to go through the LambaTest proxy in your `hyper-exeucte.yml` file
...
If you want to configure browser specific [capabilities](/docs/settings/reference#gwen-web-capabilities), you can do so in the respective `.conf` files in your `gwen/browsers` directory:
