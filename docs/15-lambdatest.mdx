...
"scripts": {
  "gwen": "gwen",
  "gwen:hyperExecute": "./hyperexecute --config gwen/hyper-execute.yml --download-artifacts --download-artifacts-path gwen/output/lt-artefacts --force-clean-artifacts"
}
```
