...
```json {2}
"scripts": {
  "gwen:hyperExecute": "./hyperexecute --config gwen/hyper-execute.yml --download-artifacts --download-artifacts-path gwen/output/hyper-execute --force-clean-artifacts"
}
```
