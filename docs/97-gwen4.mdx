...
### Changed placeholder syntax in pattern mather
...
- WebDriverManager support (SeleniumManager implementation now implicitly used only)

### Dropped settings

The following [settings](/docs/settings) have been dropped. Update your [settings files](/docs/settings#settings-files) to use the alternative.
  ...
  | `gwen.web.driver.manager`         | No alternative (SeleniumManager always implicitly used)                                         |
