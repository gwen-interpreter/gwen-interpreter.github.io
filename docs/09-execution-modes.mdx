...
To execute Gwen in batch mode, simply specify the [`-b|--batch`](/docs/cli#gwen-cli-options-batch) command line switch. Omitting it will open the [REPL](/docs/repl) otherwise.

## Interactive REPL

> Since [v1.0.0](https://github.com/gwen-interpreter/gwen-web/releases/tag/v1.0.0)

Gwen will open the [REPL console](/docs/repl) when it finishes executing features unless [batch](/docs/execution-modes#batch) mode is enabled.
...
> -  the [`--parallel`](/docs/cli#gwen-cli-options-parallel) CLI option and your [state level](/docs/settings#gwen-state-level) is set to `feature`
...
> - the [`--parallel`](/docs/cli#gwen-cli-options-parallel) CLI option and your [state level](/docs/settings#gwen-state-level) is set to `scenario`
