...
Gwen 3 uses log4j2 as of v3.1.0 (and v2.54.0 for Gwen 2). If you are passing custom `log4j.properties` files to Gwen, you will need to update them to [v2 `log4j2.properties` files](https://logging.apache.org/log4j/2.x/manual/configuration.html#Configuration_with_Properties). 
