...
[HTML reports](/docs/reports/html) will now be generated by default when you launch Gwen since the report output directory is now has a configured default. They will also be generated by default for dry runs when you specify the [`-n|--dry-run`](/docs/cli#gwen-cli-options-dry-run) switch.
