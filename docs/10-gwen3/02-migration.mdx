...
[Gwen workspaces](https://gweninterpreter.wordpress.com/2017/12/18/gwen-workspaces/) were introduced in Gwen 2 and have been deprecated in favor of JS projects in  <Link to="https://github.com/gwen-interpreter/gwen-web/releases/tag/v3.0.0">Gwen 3</Link>.
...
The legacy Java style properties format is still supported and you can contine using properties files if you wish.
...
Continue uisng your properties files as before.
...
Gwen uses log4j2 as of v[3.1.0](https://github.com/gwen-interpreter/gwen-web/releases/tag/v3.1.0) (and [2.54.0](https://github.com/gwen-interpreter/gwen-web/releases/tag/v2.54.0) for Gwen 2). If you are passing custom `log4j.properties` files to Gwen, you will need to update them to [v2 `log4j2.properties` files](https://logging.apache.org/log4j/2.x/manual/configuration.html#Configuration_with_Properties). 
