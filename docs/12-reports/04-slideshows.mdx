...
![Example HTML report](/img/reports/sample-html-slideshow-1-nav.png)
...
![Example HTML report](/img/reports/sample-html-slideshow-2-popup.png)

Clicking the *Full Screen* link will pull the slideshow out of the popup enabling you to view it in full size.

![Example HTML report](/img/reports/sample-html-slideshow-3-fullscreen.png)
