...
Create the a new `browserstack.conf` settings file in your `browsers` directory as shown.
...
Set the following enviornment variable on your system (where you will launch Gwen) to your BrowserStack username and access key:
