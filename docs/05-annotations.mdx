...
| [`@Masked`](/docs/settings#masked-data-bindings)                 | Step                                                      | Masks (hides) the value returned by a data binding                                                                    |
| [`@Parallel`](/docs/parallel#parallel-scenario-outline-examples) | Examples                                                  | Executes expanded examples in outlines in parallel                                                                    |
