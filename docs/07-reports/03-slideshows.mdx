...
With screenshot capture enabled, each generated HTML feature report will contain links to screenshot attachments in various steps and a *Slideshow* button in the status header bar at the top.
