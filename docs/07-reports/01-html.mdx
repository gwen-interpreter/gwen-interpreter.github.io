...
Captured screenshot attachments will now appear next to each step in the gnerated HTML report and a Slideshow button will be displayed in the status header bar at the top.


![Example HTML report](/img/reports/sample-html-slideshow-1.png)

Clicking the "Slideshow" button will open the slideshow in a popup box enabling you to navigate and play screenshot frames at different speeds.
