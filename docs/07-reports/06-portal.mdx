...
With the above settings in place, evaluation results will be asynchronously sent to your Report Portal server when you launch Gwen to execute your features with the `-f|--format rp` [CLI option](/docs/cli/launcher).
