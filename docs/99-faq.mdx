...
- [HTML](/docs/reports/html), [CSV](/docs/reports/csv-results), [JSON](/docs/reports/json) and [JUnit-XML](/docs/reports/junit-xml) reports.
...
Yes, see [CSV reports](/docs/reports/csv-results).
...
```shell
gwen -b -r reports -f "junit,results,html"
```

or

```shell
gwen --batch --report reports --format "junit,results,html"
```
